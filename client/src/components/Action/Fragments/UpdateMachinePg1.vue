...
const collection = reactive({
  machineType: formData.value.macAddress || data.value.machineType,
  user: formData.value.macAddress || data.value.user,
  machine: formData.value.macAddress || data.value.machine,
  model: formData.value.macAddress || data.value.model,
  os: formData.value.macAddress || data.value.os,
});
