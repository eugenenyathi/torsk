  ...
  <section v-else>
    <div class="config-view-container">
      <div v-if="routeType === 'faulty'" class="config-view-content">
        <router-link
          to="/dashboard/faulty/office-equipment/printers"
          class="config-list-item"
        >
          <Email />
          <div class="info-wrapper">
            <p class="info-head">Printers</p>
            <p class="info-text">{{ data.printers.length }}</p>
          </div>
        </router-link>
        <router-link
          to="/dashboard/faulty/office-equipment/scanners"
          class="config-list-item"
        >
          <Email />
          <div class="info-wrapper">
            <p class="info-head">Scanners</p>
            <p class="info-text">{{ data.scanners.length }}</p>
          </div>
        </router-link>
      </div>
